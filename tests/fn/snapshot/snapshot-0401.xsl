 ...
 <!-- Tests the result of navigation within a document created using the snapshot function,
  ...
  <xsl:template name="xsl:initial-template">
    <xsl:variable name="results" as="element()*">
      ...
      <e actual="{count($n1/descendant::*)}" expected="{count($n2/descendant::*)}"/>
      ...
      <k actual="{count($n1/following-or-self::node())}" expected="{count($n2/following-or-self::node())}"/>
      <l actual="{count($n1/following-or-self::*)}" expected="{count($n2/following-or-self::*)}"/>
      ...
      <o actual="{count($n1/following-sibling-or-self::node())}" expected="{count($n2/following-sibling-or-self::node())}"/>
      <p actual="{count($n1/following-sibling-or-self::*)}" expected="{count($n2/following-sibling-or-self::*)}"/>
      ...
      <v actual="{count($n1/preceding-or-self::node())}" expected="{count($n2/preceding-or-self::node())}"/>
      <w actual="{count($n1/preceding-or-self::*)}" expected="{count($n2/preceding-or-self::*)}"/>
      ...
      <z actual="{count($n1/preceding-sibling-or-self::node())}" expected="{count($n2/preceding-sibling-or-self::node())}"/>
      <A actual="{count($n1/preceding-sibling-or-self::*)}" expected="{count($n2/preceding-sibling-or-self::*)}"/>

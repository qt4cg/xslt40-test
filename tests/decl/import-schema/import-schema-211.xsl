...
default-validation="preserve">
  ...
  <xsl:template name="xsl:initial-template">
    <out>
      <xsl:element name="alpha:a" schema-role="alpha" validation="strict">10</xsl:element> 
      <xsl:element name="beta:b" schema-role="beta" validation="strict">2025-03-23</xsl:element> 
    </out>
  </xsl:template>

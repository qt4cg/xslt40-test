...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="g:glob" xmlns:g="http://global-variable.com/">
        <doc>
    ...
    <xsl:template match="/" name="xsl:initial-template" xmlns:f="http://unused.com/">
        ...
        -->
        <out>
           <xsl:variable name="loc:var" xmlns:loc="http://local-variable.com/" select="42"/> 
           <xsl:select>
               declare default element namespace "##any";
               declare namespace v="http://global-variable.com/";
               declare namespace l="http://local-variable.com/";
               count($v:glob//chap) + $l:var
           </xsl:select> 
        </out>
    </xsl:template>

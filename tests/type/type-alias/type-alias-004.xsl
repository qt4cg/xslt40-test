...
>
  ...
  <xsl:item-type name="cx:complex" as="array(type(cx:double))"/>
  ...
  <xsl:item-type name="cx:double" as="type(cx:treble)"/> 
  <xsl:item-type name="cx:treble" as="type(cx:complex)"/> <!-- circular reference -->

...
>
  ...
  <xsl:item-type name="cx:complex" as="array(cx:double)"/>
  ...
  <xsl:item-type name="cx:double" as="cx:treble"/> 
  <xsl:item-type name="cx:treble" as="cx:complex"/> <!-- circular reference -->
